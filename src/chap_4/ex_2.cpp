...
// For example, (4, 5) represents a point 4 units to the right of the vertical axis, and 5 units up 
// from the horizontal axis. The sum of two points can be defined as a new point whose x coordinate
// is the sum of the x coordinate of the two points, and whose y coordinate is the sum of the y coordinate.
...
int main()
{
	...
	std::cout << "Coordinates of p1+p2 are: " << result.x << ", " << result.y << std::endl;
